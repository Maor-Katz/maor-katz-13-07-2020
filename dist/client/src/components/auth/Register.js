...
var Register = function () {
    ...
    var registerUser = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            e.preventDefault();
            service_1.register(firstname, lastname, username, email, password, city, phone, history);
            return [2 /*return*/];
        });
    }); };
    ...
    var _g = react_1.useState(''), phone = _g[0], setPhone = _g[1];
    return (react_1.default.createElement("div", { className: "Register" },
        ...
        react_1.default.createElement("p", { className: "lead" },
            ...
            "Create your account"),
        react_1.default.createElement("form", { action: "", className: "formRegister" },
            react_1.default.createElement("div", { className: "form-group" },
                ...
                react_1.default.createElement("input", { type: "text", placeholder: "first name", onChange: function (e) { return setFirstname(e.target.value); } }),
                react_1.default.createElement("input", { type: "text", placeholder: "last name", onChange: function (e) { return setLastname(e.target.value); } }),
                react_1.default.createElement("input", { type: "text", placeholder: "city", onChange: function (e) { return setCity(e.target.value); } }),
                react_1.default.createElement("input", { type: "text", placeholder: "phone", onChange: function (e) { return setPhone(e.target.value); } })),
            react_1.default.createElement("div", { className: "form-group" },
            ...
            react_1.default.createElement("input", { type: "submit", value: "Register", className: "propItBtn", onClick: function (e) { return registerUser(e); } })),
